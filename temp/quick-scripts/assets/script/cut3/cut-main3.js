(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/cut3/cut-main3.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ba523q5I/hLSK5cH65AM3iK', 'cut-main3', __filename);
// script/cut3/cut-main3.ts

Object.defineProperty(exports, "__esModule", { value: true });
var cut_item3_1 = require("./cut-item3");
...
var Main = /** @class */ (function (_super) {
    ...
    Main.prototype.cut = function (point1, point2) {
        ...
        for (var i = 0; i < pairs.length; i++) {
            ...
            collider.apply();
            collider.node.getComponent(cut_item3_1.default).draw();
            // 克隆 N 个
            for (var j = 0; j < splitResults.length; j++) {
                var splitResult = splitResults[j];
                ...
                comp.apply();
                cloneNode.getComponent(cut_item3_1.default).draw();
            }
        }
    };
...
cc._RF.pop();
        ...
        //# sourceMappingURL=cut-main3.js.map
